...
import {
  Home, MapPin, Droplets, Zap, Phone, Menu, X, Check,
  Shield, Coffee, Wind, Bike, Wifi, Star, Quote,
} from "lucide-react";
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      bubblesRef.current.forEach((b) => {
        ...
        ctx.beginPath(); ctx.arc(b.x, b.y, cr * 2.8, 0, Math.PI * 2);
        ...
        ctx.beginPath();
        ctx.arc(b.x - cr * 0.3, b.y - cr * 0.3, cr * 0.18, 0, Math.PI * 2);
      ...
      <p className="text-gray-300 text-sm leading-relaxed mb-5 flex-1">
        ...
        {short && (
          <button
            ...
            className="ml-1 text-purple-400 hover:text-purple-300 text-xs underline underline-offset-2"
          >
            {expanded ? "less" : "more"}
          </button>
        )}
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        {/* SEO: Visible-to-crawlers h1 — hidden visually since animated version exists */}
        <h1 className="sr-only">
          Best Mansion — Paying Guest Accommodation for Men in Arumbakkam, Chennai | PG near Koyambedu, Anna Nagar &amp; Vadapalani | From ₹3,600/month
        </h1>
        <div
          className="absolute inset-0 bg-gradient-to-br from-gray-900 via-black to-purple-950"
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto pt-24">
          ...
          {/* Visual animated heading — aria-hidden since real h1 is above */}
          <div aria-hidden="true" className="text-6xl md:text-8xl font-bold tracking-tight leading-none mb-6">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center mb-16">
            ...
            <div className="relative">
              {/* Next.js <Image> for automatic optimisation (WebP, lazy load, sizing) */}
              <div className="rounded-3xl overflow-hidden" style={{ width: "100%", aspectRatio: "630/315" }}>
                <Image
                  src="/images/image1.jpg"
                  alt="Best Mansion Arumbakkam Chennai — Exterior View of PG Accommodation"
                  width={630}
                  height={315}
      ...
      <section id="features" className="relative py-32 px-6">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center space-x-5">
              ...
              <div>
                ...
                <p className="text-gray-300 mt-1">
                  Complimentary internet access throughout Best Mansion — perfect for remote work, streaming &amp; staying connected.
                </p>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-6 mb-20">
            {[
              { icon: Zap,      title: "Generator Backup",    src: "/images/image4.jpg" },
              { icon: Droplets, title: "Hot Water 24/7",      src: "/images/image7.jpg" },
              { icon: Bike,     title: "Two-Wheeler Parking", src: "/images/image9.jpg" },
              { icon: Wind,     title: "RO Drinking Water",   src: "/images/image8.jpg" },
            ].map((feature, idx) => (
              <div key={idx} className="group relative aspect-square rounded-3xl overflow-hidden cursor-pointer">
                <Image
                  src={feature.src}
                  alt={`${feature.title} — Best Mansion PG Chennai`}
                  fill
          ...
          <div className="relative bg-white bg-opacity-5 backdrop-blur-xl border border-white border-opacity-10 rounded-3xl p-12">
            ...
            <div className="relative z-10">
              <h3 className="text-3xl font-bold mb-4 text-center">
                Premium Amenities at Best Mansion PG, Arumbakkam
              </h3>
              <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">
                All-inclusive paying guest facilities for men in Chennai — no hidden charges.
              </p>
      ...
      <section id="gallery" className="relative py-32 px-6 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[
              { src: "/images/image1.jpg", title: "Exterior — Best Mansion Arumbakkam", span: "md:col-span-2", style: { aspectRatio: "630/297" } },
              { src: "/images/image3.jpg", title: "Sharing Rooms — PG Chennai" },
              { src: "/images/image6.jpg", title: "Comfortable PG Accommodation" },
              { src: "/images/image7.jpg", title: "24/7 Hot Water" },
              { src: "/images/image8.jpg", title: "RO Drinking Water" },
              { src: "/images/image4.jpg", title: "Generator — Uninterrupted Power" },
            ].map((img, idx) => (
              <div
                key={idx}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="space-y-8">
            ...
            <div className="pt-8 space-y-4">
              <a
                href="https://wa.me/+919381019882?text=Hi, I'm interested in finding a room at Best Mansion."
                target="_blank"
                ...
                aria-label="Contact Best Mansion on WhatsApp"
              >
